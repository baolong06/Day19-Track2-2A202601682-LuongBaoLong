# Test NB1 - Run directly from notebooks directory
import sys
...
# 2. Embedding model
print("\nLoading embedding model (first run downloads ~70MB)...")
...
if cloud_count >= 4:
    ...
    print("NB1 Part 2: WARN - Low cloud topic match (expected with BGE-small-en on Vietnamese)")
